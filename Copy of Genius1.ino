...
const int botao_amarelo = 5;
const int LED_vermelho = 11;
const int botao_vermelho = 1;
const int LED_azul = 0;
const int botao_azul = 2;
const int LED_verde = 6;
const int botao_verde = 10;
const int buzzer = 12;
...
int tons[4] = { NOTE_A5, NOTE_A4, NOTE_G4, somVerde };
...
int pinoAudio = 12;
int pinosLeds[4] = { LED_amarelo, LED_vermelho, LED_azul, LED_verde };
int pinosBotoes[4] = { botao_amarelo, botao_vermelho, botao_azul, botao_verde };
...
void verificarJogada() {
  if ((sequencia[passo_atual_na_sequencia] != botao_pressionado) ||(tempo_atual  - tempo_inicial < 5000)) {
